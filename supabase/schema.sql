...
INSERT INTO products (slug, title, subtitle, price, blurb, description, image_url, category_id, sort_order) VALUES
  ...
  ('black-tourmaline', 'Black Tourmaline', 'Raw specimens — grounding', 19.99, 'Raw black tourmaline specimens', 'Raw black tourmaline pieces chosen for protective, grounding energy. Perfect for entryways or workspace corners.', 'https://images.unsplash.com/photo-1528319725582-ddc096101511?w=800&h=800&fit=crop', (SELECT id FROM categories WHERE slug='crystals'), 3),
